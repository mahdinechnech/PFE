...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.email && !formData.phone) {
      newErrors.contact =
        "Veuillez fournir une adresse email ou un numéro de téléphone";
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0b1220] p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-2xl bg-[#111827] border border-gray-700 rounded-2xl shadow-2xl p-8">
            ...
            {ROLES.map((role) => {
              ...
              return (
                ...
                >
                  {isSelected && (
                    <span
                      className={`absolute top-2 right-2 p-1 rounded-full font-semibold ${colors.badge}`}
                    >
                      <Check size={12} />
                    </span>
                  )}
                  ...
                  <span
                    className={`font-bold text-sm ${isSelected ? colors.text : "text-gray-300"}`}
                  >
                    {role.label}
                  </span>
        ...
        {selectedRole && (
          <div
            className={`flex items-center gap-2 px-4 py-2 rounded-lg border mb-5 ${selectedColors.bg} ${selectedColors.border}`}
          >
